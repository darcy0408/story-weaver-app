...
void main() {
  group('StoryComplexityService.getAgeGuidelines', () {
    test('returns early-childhood rules for ages 3-5', () {
      ...
      expect(rules['vocabulary_level'], contains('Basic nouns and verbs'));
    ...
    test('returns teen rules for ages 13-15', () {
      ...
      expect(rules['concepts'], contains('Identity, social issues, and emotional complexity'));
    ...
    test('returns adult rules for ages 16+', () {
      ...
      expect(rules['vocabulary_level'], contains('Mature vocabulary'));
    });
  });
